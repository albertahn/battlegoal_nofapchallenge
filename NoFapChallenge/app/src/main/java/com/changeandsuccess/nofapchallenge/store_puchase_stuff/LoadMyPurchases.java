 ...
 */
public class LoadMyPurchases extends AsyncTask<String, Integer, String> {
...
// ProgressBar progressBar;
    ...
    public LoadMyPurchases(String userID, Activity activity) {
    ...
    protected String doInBackground(String... params){
        ...
        try {
            ...
            final String STREAMURL = "http://mobile.tanggoal.com/buy/show_my_purchases/"+userID;//activity.getResources().getString(R.string.default_comments_url);
